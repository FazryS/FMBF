#Terima Kasih Kepada
#Fazry S, Kalzee, Dobleh, dan grup CODE CRACKERS
import os,sys
import rich
try: import requests
...
██║     ██║ ╚═╝ ██║██████╔╝██║     
╚═╝     ╚═╝     ╚═╝╚═════╝ ╚═╝                                                                                                                                                               
  \033[44m\033[1;37m Ingformasi Script  \033[41m\033[1;37m FMBF V 2.0 \x1b[0m\n
 Author   : {P}Fazry Sablenk{Q}
 Coded    : {P}CODE CR4CKERS{Q}
 Whatsapp : +6283109115523
 Facebook : FAZRY S  FRISTYLE ({II}Kang Colay{Q})
 Github   : https://github.com/FazryS
 """)
		...
		for t in range(tanya_total):
			...
			try:
				if idt == "me":idt = "me"
					...
					payload = {"fburl": "https://touch.facebook.com/{}".format(idt), "check": "Lookup"}
					if "facebook" in idt:
...
#print(cokki)
#cek_cookies_by_kenzii(userf, cokki, memek)
